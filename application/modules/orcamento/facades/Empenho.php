 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Empenho
 * @author Gesley B Rodrigues <rodrigues.gesley@gmail.com>
 ...
 */
class Orcamento_Facade_Empenho extends Orcamento_Facade_Base
{
    ...
    public function init ()
    {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_Empenho ();
        
        // Define a controle desta action
        $this->_controle = 'empenho';
    }
