 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Regracnj
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Facade_Regracnj extends Orcamento_Facade_Base
{
    ...
    public function init ()
    {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_Regracnj ();
        
        // Define a controle desta action
        $this->_controle = 'regracnj';
    }
