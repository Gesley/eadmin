 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Gerarrelatoriocnj
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Facade_Gerarrelatoriocnj extends Orcamento_Facade_Base
{
    ...
    public function init ()
    {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_Gerarrelatoriocnj ();
        
        // Define a controle desta action
        $this->_controle = 'gerarrelatoriocnj';
    }
