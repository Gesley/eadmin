 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Contingenciamento
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Facade_Importarcontingenciamento extends Orcamento_Facade_Base {
    ...
    public function init() {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_ImportarContingenciamento();
