 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Movimentacaocrednova
 * @author Gesley B Rodrigues <rodrigues.gesley@gmail.com>
 ...
 */
class Orcamento_Facade_Movimentacaocrednova extends Orcamento_Facade_Base
{
    ...
    public function init ()
    {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_Movimentacaocrednova ();

        // Define a controle desta action
        $this->_controle = 'movimentacaocrednova';
    }
