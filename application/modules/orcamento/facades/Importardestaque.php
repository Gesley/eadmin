 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Destaque
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Facade_Importardestaque extends Orcamento_Facade_Base {
    ...
    public function init() {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_ImportarDestaque();
