 ...
 *
 * @category Orcamento
 * @package Orcamento_Facade_Dotacao
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Facade_Importardotacao extends Orcamento_Facade_Base {
    ...
    public function init() {
        ...
        $this->_negocio = new Orcamento_Business_Negocio_ImportarDotacao();
