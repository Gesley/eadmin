...
/**
 * Disponibiliza as funcionalidades ao usuário sobre responsável.
 *
 * @category Orcamento
 * @package Orcamento_ResponsavelController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_ResponsavelController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de responsáveis';
		...
		$camposDetalhes = array (	'RESP_CD_RESPONSAVEL' => array ('title' => 'Responsável', 'abbr' => '' ),
									'LOTA_SIGLA_LOTACAO' => array ('title' => 'Sigla', 'abbr' => '' ),
									'LOTA_DSC_LOTACAO' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle =  'Visualizar responsável';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar responsável';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir responsável';
	...
	public function ajaxresponsaveisAction() {
		$descricao = $this->_getParam ( 'term', '' );
		$ug = $this->_getParam ( 'ug', '' );
        
		$negocio = new $this->_classeNegocio ();
		$lotacoes = $negocio->retornaResponsaveisAutoComplete ($ug, $descricao );
		$fim = count ( $lotacoes );
		for($i = 0; $i < $fim; $i ++) {
