...
/**
 * Disponibiliza as funcionalidades ao usuário sobre objetivo.
 *
 * @category Orcamento
 * @package Orcamento_ObjetivoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_ObjetivoController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de objetivos';
		...
		$camposDetalhes = array (	'POBJ_CD_OBJETIVO' => array ('title' => 'Objetivo', 'abbr' => '' ),
									'POBJ_AA_OBJETIVO' => array ('title' => 'Ano', 'abbr' => '' ),
									'POBJ_DS_OBJETIVO' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir objetivo';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar objetivo';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar objetivo';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir objetivos';
