...
/**
 * Disponibiliza as funcionalidades ao usuário sobre tipos operacionais.
 *
 * @category Orcamento
 * @package Orcamento_TipooperacionalController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_TipooperacionalController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Tipo operacional';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de tipos operacionais';
		...
		$camposDetalhes = array (	'POPE_CD_TIPO_OPERACIONAL' => array ('title' => 'Tipo operacional', 'abbr' => '' ),
									'POPE_DS_TIPO_OPERACIONAL' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir tipo operacional';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar tipo operacional';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar tipo operacional';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir tipos operacionais';
