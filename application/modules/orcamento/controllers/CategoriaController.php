...
/**
 * Disponibiliza as funcionalidades ao usuário sobre categoria.
 *
 * @category Orcamento
 * @package Orcamento_CategoriaController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_CategoriaController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de categorias';
		...
		$camposDetalhes = array (	'CATE_CD_CATEGORIA' => array ('title' => 'Categoria de gasto',  'abbr' => '' ),
									 'CATE_DS_CATEGORIA' => array ('title' => 'Descrição da categoria', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir categoria';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar categoria';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar categoria';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir categorias';
