...
/**
 * Disponibiliza as funcionalidades ao usuário sobre tipo de despesa.
 *
 * @category Orcamento
 * @package Orcamento_TipodespesaController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_TipodespesaController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->title = 'Caráter da despesa';
    ...
    public function indexAction()
    {
        ...
        $this->view->telaTitle = 'Listagem de caráter da despesa';
        ...
        $camposDetalhes = array(
            'TIDE_CD_TIPO_DESPESA' => array('title' => 'Caráter da despesa', 'abbr' => ''),
            'TIDE_DS_TIPO_DESPESA' => array('title' => 'Descrição', 'abbr' => ''),
            'TIDE_IC_RESERVA_RECURSO' => array('title' => 'Reserva', 'abbr' => '')
        );
        $camposOcultos = array();
    ...
    {
        // Título da tela (action)
        $this->view->telaTitle = 'Incluir caráter da despesa';
    ...
    {
        // Título da tela (action)
        $this->view->telaTitle = 'Visualizar caráter da despesa';
    ...
    {
        // Título da tela (action)
        $this->view->telaTitle = 'Editar caráter da despesa';
    ...
    {
        // Título da tela (action)
        $this->view->telaTitle = 'Excluir caráter da despesa';
