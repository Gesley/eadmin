...
/**
 * Disponibiliza as funcionalidades ao usuário sobre natureza de despesa.
 *
 * @category Orcamento
 * @package Orcamento_ElementoController
 * @todo Renomear o nome dessa estrutura, e todas suas respectivas chamadas,
 *       para o nome negocial mais recente, conforme definido pelo usuário
 *       gestor: natureza da despesa.
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_ElementoController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Natureza da despesa';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de natureza de despesa';
		...
		$camposDetalhes = array (	'EDSB_CD_ELEMENTO_DESPESA_SUB' => array ('title' => 'Natureza da despesa', 'abbr' => '' ),
									'EDSB_DS_ELEMENTO_DESPESA_SUB' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir natureza da despesa';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar natureza da despesa';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar natureza da despesa';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir natureza da despesa';
	...
	private function erroOperacao($mensagemErro) {
        ...
        public function ajaxelementoAction(){
        $cod         = $this->_getParam('term','');
		$negocio = new Trf1_Orcamento_Negocio_Elemento();
		$ptres = $negocio->getElementoAjax($cod);
