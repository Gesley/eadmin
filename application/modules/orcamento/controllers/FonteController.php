...
/**
 * Disponibiliza as funcionalidades ao usuário sobre fonte.
 *
 * @category Orcamento
 * @package Orcamento_FonteController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_FonteController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de fontes';
		...
		$camposDetalhes = array (	'FONT_CD_FONTE' => array ('title' => 'Fonte de recurso', 'abbr' => '' ),
									'FONT_DS_FONTE' => array ('title' => 'Descrição da fonte', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir fonte';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar fonte';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle ='Editar fonte';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir fontes';
	...
	public function ajaxfonteAction ()
	{
		...
		$negocio = new Trf1_Orcamento_Negocio_Fonte ();
		$ptres = $negocio->getFonteAjax ( $cod );
