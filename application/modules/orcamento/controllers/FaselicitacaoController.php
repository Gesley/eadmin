...
/**
 * Disponibiliza as funcionalidades ao usuário sobre fase de licitação.
 *
 * @category Orcamento
 * @package Orcamento_FaselicitacaoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_FaselicitacaoController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Fase da licitação';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de fases da licitação';
		...
		$camposDetalhes = array (	'FASL_CD_FASE' => array ('title' => 'Fase da licitação', 'abbr' => '' ),
									'FASL_DS_FASE' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir fase da licitação';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar fase da licitação';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar fase da licitação';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir fases da licitação';
