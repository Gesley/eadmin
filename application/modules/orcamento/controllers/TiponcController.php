...
/**
 * Disponibiliza as funcionalidades ao usuário sobre tipos de notas de crédito.
 *
 * @category Orcamento
 * @package Orcamento_TiponcController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_TiponcController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Tipo de nota de crédito';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de tipos de nota de crédito';
		...
		$camposDetalhes = array (	'TPNC_CD_TIPO_NC' => array ('title' => 'Tipo de nota crédito', 'abbr' => '' ),
									'TPNC_DS_TIPO_NC' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir tipo de nota de crédito';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar tipo de nota de crédito';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar tipo de nota de crédito';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir tipos de nota de crédito';
