...
/**
 * Disponibiliza as funcionalidades ao usuário sobre unidade orçamentária.
 *
 * @category Orcamento
 * @package Orcamento_UoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_UoController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Unidade orçamentária';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem das unidades orçamentárias';
		...
		$camposDetalhes = array (	'UNOR_CD_UNID_ORCAMENTARIA' => array ('title' => 'UO', 'abbr' => 'Código da unidade orçamentária' ),
									'UNOR_DS_UNID_ORCAMENTARIA' => array ('title' => 'Descrição', 'abbr' => 'Descrição da unidade orçamentária' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir unidade orçamentária';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar unidade orçamentária';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar unidade orçamentária';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir unidades orçamentárias';
