...
/**
 * Disponibiliza as funcionalidades ao usuário sobre programa.
 *
 * @category Orcamento
 * @package Orcamento_ProgramaController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_ProgramaController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de programas';
		...
		$camposDetalhes = array (	'PPRG_AA_PROGRAMA' => array ('title' => 'Ano', 'abbr' => '' ),
									'PPRG_CD_PROGRAMA' => array ('title' => 'Programa', 'abbr' => '' ),
									'PPRG_DS_PROGRAMA' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir programa';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar programa';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar programa';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir programas';
