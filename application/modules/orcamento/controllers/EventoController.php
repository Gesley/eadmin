...
/**
 * Disponibiliza as funcionalidades ao usuário sobre evento.
 *
 * @category Orcamento
 * @package Orcamento_EventoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_EventoController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de eventos';
		...
		$camposDetalhes = array (	'EVEN_CD_EVENTO' => array ('title' => 'Evento', 'abbr' => '' ),
									'EVEN_DS_EVENTO' => array ('title' => 'Descrição', 'abbr' => '' ),
									'EVEN_IC_SINAL_EVENTO' => array ('title' => 'Sinal', 'abbr' => '' ),
									'EVEN_DS_DOCUMENTO' => array ('title' => 'Documento', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir evento';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar evento';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar evento';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir eventos';
