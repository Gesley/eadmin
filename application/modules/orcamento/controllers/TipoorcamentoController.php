...
/**
 * Disponibiliza as funcionalidades ao usuário sobre tipos de orçamento.
 *
 * @category Orcamento
 * @package Orcamento_TipoorcamentoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_TipoorcamentoController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Tipo de orçamento';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de tipos de orçamento';
		...
		$camposDetalhes = array (	'PORC_CD_TIPO_ORCAMENTO' => array ('title' => 'Tipo de orçamento', 'abbr' => '' ),
									'PORC_DS_TIPO_ORCAMENTO' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir tipo de orçamento';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar tipo de orçamento';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar tipo de orçamento';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir tipos de orçamento';
