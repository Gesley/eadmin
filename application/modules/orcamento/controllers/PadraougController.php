...
/**
 * Disponibiliza as funcionalidades ao usuário sobre padrão da unidade gestora.
 *
 * @category Orcamento
 * @package Orcamento_PadraougController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_PadraougController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Padrão da unidade gestora';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem dos padrões das unidades gestoras';
		...
		$camposDetalhes = array (	'PADR_CD_UG' => array ('title' => 'Padrão da UG', 'abbr' => '' ),
									'PADR_DS_UG' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir padrão de unidade gestora';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar padrão de unidade gestora';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar padrão de unidade gestora';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir padrões de unidade gestora';
