...
/**
 * Disponibiliza as funcionalidades ao usuário sobre demandante.
 *
 * @category Orcamento
 * @package Orcamento_DemandanteController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_DemandanteController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de demandantes (dos recursos orçamentários)';
		...
		$camposDetalhes = array (	'DEMN_CD_DEMANDANTE' => array ('title' => 'Demandante', 'abbr' => '' ),
									'DEMN_DS_DEMANDANTE' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir demandante';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar demandante';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar demandante';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir demandantes';
