...
/**
 * Disponibiliza as funcionalidades ao usuário sobre tipos de recurso.
 *
 * @category Orcamento
 * @package Orcamento_TiporecursoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_TiporecursoController extends Zend_Controller_Action {
	/**
	...
	public function init() {
		...
		$this->view->title = 'Tipo de recurso';
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de tipos de recurso';
		...
		$camposDetalhes = array (	'TREC_CD_TIPO_RECURSO' => array ('title' => 'Tipo de recurso', 'abbr' => '' ),
									'TREC_DS_TIPO_RECURSO' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir tipo de recurso';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar tipo de recurso';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar tipo de recurso';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir tipos de recurso';
