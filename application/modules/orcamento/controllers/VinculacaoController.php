...
/**
 * Disponibiliza as funcionalidades ao usuário sobre vinculação.
 *
 * @category Orcamento
 * @package Orcamento_VinculacaoController
 * @author Anderson Sathler M. Ribeiro <asathler@gmail.com>
 ...
 */
class Orcamento_VinculacaoController extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$this->view->telaTitle = 'Listagem de vinculações (dos recursos orçamentários)';
		...
		$camposDetalhes = array (	'VINC_CD_VINCULACAO' => array ('title' => 'Vinculação', 'abbr' => '' ),
									'VINC_DS_VINCULACAO' => array ('title' => 'Descrição', 'abbr' => '' )
								);
		$camposOcultos = array ();
	...
	public function incluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Incluir vinculação';
	...
	public function detalheAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Visualizar vinculação';
	...
	public function editarAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Editar vinculação';
	...
	public function excluirAction() {
		// Título da tela (action)
		$this->view->telaTitle = 'Excluir vinculações';
