...
class Orcamento_Form_Importarsuplementacao extends Orcamento_Form_ImportacaoBase {
   
       public function init ()
    {
        // Definições iniciais do formulário
        $this->retornaFormulario ( 'importarsuplementacao' );
        ...
        $floTotalJan->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalFev->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalMar->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalAbr->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalMai->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalJun->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalJul->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalAgo->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalSet->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalOut->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalNov->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalDez->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotal->setAttrib ( 'size', 15 )->setAttribs ( array ( 'class' => '' ) )->setValue (
        0 );
