 ...
 *
 * @category Orcamento
 * @package Orcamento_Form_Importarrestosapagar
 * @author Ricardo Ramon <rrsantos2@stefanini.com>
 ...
 */
class Orcamento_Form_Importarrestosapagar extends Orcamento_Form_ImportacaoBase {
...
/**
    ...
    public function init ()
    {
        ...
        $txtUg->setLabel ( 'Unidade gestora:' )->addFilter ( 'StripTags' )->addMultiOptions ( array ('' => 'Selecione' ) )->addMultiOptions ( $tbUG->retornaCombo () )->setRequired ( true );
        ...
        $cboCategoria = new Zend_Form_Element_Select ( 'IMPO_IC_CATEGORIA' );
        ...
        $cboVinculacao = new Zend_Form_Element_Select ( 'IMPO_CD_VINCULACAO' );
        ...
        $cboFonte = new Zend_Form_Element_Select ( 'IMPO_CD_FONTE' );        
        ...
        $floTotalJan->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalFev->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalMar->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalAbr->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalMai->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalJun->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalJul->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalAgo->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalSet->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalOut->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalNov->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotalDez->setAttribs ( array ( 'size', 25, 'class' => 'valordespesa' ) )->setValue (
        0 );
        ...
        $floTotal->setAttribs ( array ( 'size', 25, 'class' => '' ) )->setValue (
        0 );
        $floTotal->setAttrib ( 'maxlength', 40 );
        $floTotal->addFilter ( 'StringTrim' );
        $floTotal->setRequired ( true );

        // Define opções para o campo inciso
        $facadeInciso = new Orcamento_Facade_Inciso ();

        $cboInciso = new Zend_Form_Element_Select ( 'IMPO_ID_INCISO' );
        $cboInciso->setLabel ( 'Inciso:' );
        $cboInciso->addFilter ( 'StripTags' );
        $cboInciso->addMultiOption('',':: Selecione ::')
        ->addMultiOptions ( $facadeInciso->retornaComboInciso () );

        // Define opções para o campo alinea
        $facadeAlinea = new Orcamento_Facade_Alinea ();

        $cboAlinea = new Zend_Form_Element_Select ( 'IMPO_ID_ALINEA' );
        $cboAlinea->setLabel ( 'Alínea:' );
        $cboAlinea->addFilter ( 'StripTags' );
        $cboAlinea->addMultiOption('',':: Selecione um inciso ::');
        ...
        $this->addElement ( $cboInciso );
        $this->addElement ( $cboAlinea );
