 ...
 */
class Orcamento_Form_Macrodesafio extends Orcamento_Form_Base
{
    ...
    public function init ()
    {
        ...
        $this->retornaFormulario ( 'macrodesafio' );
        
        // Cria o campo ESFE_CD_MACRODESAFIO
        $txtCodigo = new Zend_Form_Element_Hidden ( 'MACRO_ID_MACRODESAFIO' );
        ...
        // Cria o campo ESFE_DS_MACRODESAFIO
        $txtDescricao = new Zend_Form_Element_Text ( 'MACRO_TX_MACRODESAFIO' );
        ...
        // Ano
        $txtAno = new Zend_Form_Element_Select ( 'MACRO_AA_EXERCICIO' );
