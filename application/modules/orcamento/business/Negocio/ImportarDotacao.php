...
/**
 * Contém as regras negociais sobre Dotacao
 *
 * @category Orcamento
 * @package Orcamento_Business_Negocio_Dotacao
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Business_Negocio_ImportarDotacao extends Orcamento_Business_Importacao_Base {
    ...
    public function init() {
        ...
        $tipoImportacao->tipo = Orcamento_Business_Importacao_Base::ARQUIVO_DOTACAO;
    ...
    /**
     * Trata a edição de dados antes de salvar
     */
