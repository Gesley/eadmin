 ...
 */
class Orcamento_Business_Negocio_Importarne extends Orcamento_Business_Negocio_Base {
     ...
     * @return @array
     */
    public function incluir($name, $nc, $linha) {
        ...
        $dados = array(
            ...
            'IMPD_DS_CLASSE_ARQUIVO' => substr($nc['NOEM_CD_NOTA_EMPENHO'], 4, 2),
            'IMPD_NR_ERRO' => 0
        );            
    ...
    public function retornaOpcoesGrid() {
        ...
        $opcoes ['ocultos'] = array(); // esconde o código
 ...
 /**
    ...
    public function retornaRestricoes($acao = 'todos', $chaves = null) {
        ...
        // $restricao [ 'index' ] = " ORDER BY DATA_EMISSAO DESC ";

        $restricao ['index'] = " AND IMPD_DS_CLASSE_ARQUIVO = 'NE' ORDER BY IMPD_DH_IMPORTACAO DESC";
