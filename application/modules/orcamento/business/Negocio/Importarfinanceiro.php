 ...
 */
class Orcamento_Business_Negocio_Importarfinanceiro extends Orcamento_Business_Importacao_Base {
    ...
    public function init() {
        ...
        // Define a negocio
        $this->_negocio = 'importarfinanceiro';

    }

    /**
     * Trata a inclusao de dados financeiros antes de salvar
     */    
    public function incluirDados($dados, $impoidimport){
        
        // codigo da tabela impa
        $dados['IMPO_ID_IMPORT_ARQUIVO'] = $impoidimport;
        
        // converte a moeda para banco de dados oracle
...
IMPO_CD_FONTE||' - '||FONT_DS_FONTE AS FONT_DS_FONTE, 
                                    IMPO_CD_VINCULACAO,
                                    (
    SELECT VINC_DS_VINCULACAO FROM CEO_TB_VINC_VINCULACAO 
    WHERE VINC_CD_VINCULACAO = SUBSTR(IMPO_CD_VINCULACAO, 0,3)
                                    ) AS VINC_DS_VINCULACAO,
                                    IMPO_IC_CATEGORIA,
                                    CATE_DS_CATEGORIA,
                                    IMPO_ID_ALINEA,
                                    ALIN_DS_ALINEA,
        ...
        $campos [ 'excluir' ] .= "
                                    ...
                                    IMPO_CD_NATUREZA_DESPESA AS \"Natureza da despesa\",
    ...
    /**
     * Apaga o inciso e uma alinea
     * 
     * @param int $codigo
     * @return array
     */
    public function excluirIncisoAlinea($codigo)
    {
        $sql = "UPDATE CEO_TB_IMPO_IMPORTACAO 
            SET IMPO_ID_ALINEA = NULL, 
            IMPO_ID_INCISO = NULL
            WHERE IMPO_ID_IMPORTACAO = $codigo
            ";
