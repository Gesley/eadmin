...
/**
 * Contém as regras negociais sobre Pago
 *
 * @category Orcamento
 * @package Orcamento_Business_Negocio_Pago
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Business_Negocio_ImportarPago extends Orcamento_Business_Importacao_Base {
    ...
    public function init() {
        ...
        parent::init(parent::PADRAO2);
        
        $tipoImportacao = new Zend_Session_Namespace('tipoImportacao');
        $tipoImportacao->tipo = Orcamento_Business_Importacao_Base::ARQUIVO_PAGO;
    ...
    public function editar($dados)
    {
        ...
        if( !is_int($dados['IMPO_CD_PTRES']) ){
            unset($dados["IMPO_CD_PTRES"]);
        }else{
