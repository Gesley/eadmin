 ...
 */
class Orcamento_Business_Negocio_Importarliquidado extends Orcamento_Business_Importacao_Base {
    ...
    public function editar($dados)
    {
        ...
        if($dados['IMPO_CD_FONTE'] == ''){
            $dados['IMPO_CD_FONTE'] = 0;
        }
...
CASE WHEN IMPO_VL_TOTAL_JAN > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_JAN, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_JAN,

CASE WHEN IMPO_VL_TOTAL_FEV > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_FEV, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_FEV,

CASE WHEN IMPO_VL_TOTAL_MAR > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_MAR, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_MAR,

CASE WHEN IMPO_VL_TOTAL_ABR > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_ABR, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_ABR,

CASE WHEN IMPO_VL_TOTAL_MAI > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_MAI, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_MAI,

CASE WHEN IMPO_VL_TOTAL_JUN > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_JUN, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_JUN,

CASE WHEN IMPO_VL_TOTAL_JUL > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_JUL, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_JUL,
CASE WHEN IMPO_VL_TOTAL_AGO > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_AGO, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_AGO,

CASE WHEN IMPO_VL_TOTAL_SET > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_SET, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_SET,

CASE WHEN IMPO_VL_TOTAL_OUT > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_OUT, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_OUT,

CASE WHEN IMPO_VL_TOTAL_NOV > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_NOV, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_NOV,

CASE WHEN IMPO_VL_TOTAL_DEZ > 0 THEN
    TO_CHAR(IMPO_VL_TOTAL_DEZ, 'FML9G999G999G999G999G999G990D00') 
ELSE
    '0,00'
END AS IMPO_VL_TOTAL_DEZ,
...
TO_CHAR(
       IMPO_VL_TOTAL_JAN+
        ...
        IMPO_VL_TOTAL_OUT+
        IMPO_VL_TOTAL_NOV+
        IMPO_VL_TOTAL_DEZ, 'FML9G999G999G999G999G999G990D00') AS IMPO_VL_TOTAL
...
";
        ...
        $campos [ 'detalhe' ] = "
                                    ...
                                    IMPO_CD_NATUREZA_DESPESA||' - '||EDSB_DS_ELEMENTO_DESPESA_SUB                                    
                                    IMPO_ID_ALINEA,
                                    ALIN_DS_ALINEA,
                                    IMPO_ID_INCISO,
                                    INCI_DS_INCISO,                                    
