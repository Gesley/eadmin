...
/**
 * Contém as regras negociais sobre Contingenciamento
 *
 * @category Orcamento
 * @package Orcamento_Business_Negocio_ImportarContingenciamento
 * @author Sandro Maceno <smaceno@stefanini.com>
 ...
 */
class Orcamento_Business_Negocio_ImportarContingenciamento extends Orcamento_Business_Importacao_Base {
    ...
    public function init() {
        ...
        parent::init(parent::PADRAO1);
        
        $tipoImportacao = new Zend_Session_Namespace('tipoImportacao');
        $tipoImportacao->tipo = Orcamento_Business_Importacao_Base::ARQUIVO_CONTINGENCIAMENTO;

        // Instancia a classe model
        $this->_model = new Orcamento_Model_DbTable_Importacao();
        
        // Define a negocio
        $this->_negocio = Zend_Controller_Front::getInstance()->getRequest()->getControllerName();
    }
    ...
    public function editar($dados)
    {
        ...
        unset($dados["Enviar"]);
        // remove o arquivo
        unset($dados['CEO_TB_IMPO_IMPORTACAO']);
