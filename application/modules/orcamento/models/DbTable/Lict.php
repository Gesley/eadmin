 ...
 */
class Orcamento_Model_DbTable_Lict extends Orcamento_Model_DbTable_Base {
	 ...
	 * @var string
	 */
	protected $_name = 'CEO_TB_LICT_LICITACAO';
	 ...
	 * @var string
	 */
	protected $_primary = 'LICT_ID_LICITACAO';
	 ...
	 * @var string
	 */
	protected $_sequence = 'CEO_SQ_LICT';
