...
class Transporte_Form_Requisicao extends Zend_Form
{
    public function init()
    {
        ...
        $requ_sg_secao = new Zend_Form_Element_Text('REQU_SG_SECAO');
        $requ_sg_secao//->setRequired(true)
                     ->setLabel('Sigla Seção LIST:')
                     ->addFilter('StripTags')
                     ->addFilter('StringTrim')
                     ->addValidator('NotEmpty')
                     ->addValidator('Alnum', false, true)
        ...
        $requ_cd_lotacao = new Zend_Form_Element_Text('REQU_CD_LOTACAO');
        $requ_cd_lotacao//->setRequired(true)
                     ->setLabel('Cód Lotação LIST:')
                     ->addFilter('StripTags')
                     ->addFilter('StringTrim')
                     ->addValidator('NotEmpty')
                     ->addValidator('Alnum', false, true)
