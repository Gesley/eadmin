...
class Sisad_FormularioavisoController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        $this->view->title = "Formulário de Aviso";
    }

    public function formAction() {
        $form = new Sisad_Form_Formularioaviso();
    ...
    public function visualizarAction() {
        $this->view->title = "Pré-visualização do Aviso";
        $form = new Sisad_Form_Formularioaviso();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($data)) {
                ...
                $name = 'SISAD_TEMP_DOC_AVISO_VISUALIZAR_DOCUMENTO' . date("dmYHisu") . '.pdf';
                        ...
                        try {
                            ...
                            $idDocumento                   = $row->save();
                             $rowDocmDocumento = $tabelaSadTbDocmDocumento->fetchRow("DOCM_ID_DOCUMENTO = $idDocumento");
                                    /*
                                     * Envidando por email o número do arquivo gravado no banco
                                     */
                                    ...
                                    $corpo        = "Cadastro efetuado com sucesso</p>
                                              Número do Documento: <a href=\"http://$http/$fullBaseUrl/sisad/pesquisadcmto/pesquisa-doc-email/DOCM_ID_DOCUMENTO/" . $rowDocmDocumento['DOCM_NR_DOCUMENTO'] . "\"><b>" . $rowDocmDocumento['DOCM_NR_DOCUMENTO'] . "</b> </a><br/>";
...
//                                $this->_helper->flashMessenger ( array('message' => $msg_to_user, 'status' => 'error'));
                        ...
                        $this->_helper->_redirector('form', 'formularioaviso', 'sisad');
                    } else {
                        /* tratamento de erro */
