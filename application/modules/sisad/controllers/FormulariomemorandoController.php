<?php
class Sisad_FormulariomemorandoController extends Zend_Controller_Action
{
	/**
    ...
    {
        $this->view->title = "Formulário de Memorando";
    }

   public function formAction()
    {
        $form   = new Sisad_Form_Formulariomemorando();
//        $table  = new Sisad_Model_DataMapper_Documento();
    ...
    public function visualizarAction() {
        $this->view->title = "Pré-visualização do Memorando";
        $form = new Sisad_Form_Formulariomemorando();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($data)) {
                ...
                $this->view->telefone = $data["TELEFONE"];
                ...
                */
                ...
                $name =  'SISAD_TEMP_DOC_MEMORANDO_VISUALIZAR_DOCUMENTO' . date("dmYHisu") .'.pdf';
...
//                                $this->_helper->flashMessenger ( array('message' => $msg_to_user, 'status' => 'error'));
                            ...
                            $this->_helper->_redirector('form','Formulariomemorando','sisad');
                        } else {
                            /*tratamento de erro*/
