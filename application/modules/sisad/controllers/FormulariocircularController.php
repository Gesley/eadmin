<?php
class Sisad_FormulariocircularController extends Zend_Controller_Action
{
	/**
    ...
    {
        $this->view->title = "Formulário de Circular";
    }

   public function formAction()
    {
        $form   = new Sisad_Form_Formulariocircular();
//        $table  = new Sisad_Model_DataMapper_Documento();
    ...
    public function visualizarAction() {
        $this->view->title = "Pré-visualização da Circular";
        $form = new Sisad_Form_Formulariocircular();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($data)) {
                ...
                $name =  'SISAD_TEMP_DOC_CIRCULAR_VISUALIZAR_DOCUMENTO' . date("dmYHisu") .'pdf';
...
//                                $this->_helper->flashMessenger ( array('message' => $msg_to_user, 'status' => 'error'));
                            ...
                            $this->_helper->_redirector('form','formulariocircular','sisad');
...
//                                        $this->_helper->flashMessenger ( array('message' => $msg_to_user, 'status' => 'error'));
                                        ...
                                        try {
                                            ...
                                            */
                                               ...
                                               $corpo = "Cadastro efetuado com sucesso</p>
                                                         Número do Documento: 
                                                         <a href=\"http://sistemas.trf1.jus.br/app/e-Admin/sisad/pesquisadcmto/"
                                                         . $rowDocmDocumento['DOCM_NR_DOCUMENTO'] 
                                                         . "\"><b>" . $rowDocmDocumento['DOCM_NR_DOCUMENTO'] 
                                                         . "</b> </a><br/>";
