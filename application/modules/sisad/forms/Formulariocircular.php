<?php
class Sisad_Form_Formulariocircular extends Zend_Form {
   ...
   public function init()
   {
        ...
        $docm_nr_dcmto_usuario->setRequired(false)
                          ->addFilter('Alnum')
                          ->setLabel('Número Circular do Usuário:')
