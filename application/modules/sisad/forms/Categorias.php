<?php
class Sisad_Form_Categorias extends Zend_Form
{
    public function init()
    {
        ...
        $cate_no_categoria = new Zend_Form_Element_Text('CATE_NM_CATEGORIA');
        ...
        $cate_sg_secao_categoria = new Zend_Form_Element_Hidden('CATE_SG_SECAO_CATEGORIA');
        $cate_sg_secao_categoria->setRequired(false)
                          ->removeDecorator('Label')
                          ->removeDecorator('HtmlTag');
        
        $cate_cd_lotacao_categoria = new Zend_Form_Element_Hidden('CATE_CD_LOTACAO_CATEGORIA');
        $cate_cd_lotacao_categoria->setRequired(false)
                          ->removeDecorator('Label')
                          ->removeDecorator('HtmlTag');
        ...
        $this->addElements(array($cate_id_categoria,
                                     ...
                                     $cate_ds_observacao,
                                     $cate_ic_ativo,
                                     $cate_sg_secao_categoria,
                                     $cate_ds_descricao_cor,
                                     $cate_cd_lotacao_categoria,
