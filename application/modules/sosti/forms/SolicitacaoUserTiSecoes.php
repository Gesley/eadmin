<?php
class Sosti_Form_SolicitacaoUserTiSecoes extends Zend_Form
{
...
//        $SgrsGrupoServico = $SosTbSgrsGrupoServico->getGrupoServicoBySecsubsec(2, true);
        ...
        $getSecao = $rh_central->getSecoestrf1();
        $secao = App_UtilArray::retiraposicaoarray2dby($getSecao, "LOTA_COD_LOTACAO", 2);
