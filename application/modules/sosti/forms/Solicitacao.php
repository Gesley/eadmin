<?php
class Sosti_Form_Solicitacao extends Zend_Form
{
...
//        endforeach;
       ...
       $ssol_nm_usuario_externo//->setRequired(true)
        ...
        $de_mat = new Zend_Form_Element_Text('DE_MAT');
...
//        $SgrsGrupoServico = $SosTbSgrsGrupoServico->getGrupoServicoBySecsubsec(2, true);
        ...
        foreach ($SgrsGrupoServico as $SgrsGrupoServico_p):
            $sgrs_id_grupo->addMultiOptions(array(Zend_Json::encode($SgrsGrupoServico_p) => $SgrsGrupoServico_p["SGRS_DS_GRUPO"]), 'selected', 'selected');
        endforeach;
