...
class Sosti_Form_DesvincularAtendente extends Zend_Form {
 public function init()
    {
        ...
        $mofa_ds_complemento->setRequired(true)
                            ->setLabel('Descrição da Desvinculação:')
        ...
        $this->addElements(array($mofa_id_movimentacao, $docm_id_documento, $docm_nr_documento, $mofa_ds_complemento));
    }
}
