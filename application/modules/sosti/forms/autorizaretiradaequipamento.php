<?php
class Sosti_Form_autorizaretiradaequipamento extends Zend_Form
{
    public function init()
    {
        ...
        $descricaoRecebimento = new Zend_Form_Element_Textarea('DESCRICAO_RETIRADA');
        ...
        $acao->setValue('autorizarRetirada');
