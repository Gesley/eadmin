...
class Sosti_GestaodedemandasdonocController extends Zend_Controller_Action {
	/**
    ...
    public function indexAction() {
         ...
         * Definições
         */
        $idCaixa = Trf1_Sosti_Definicoes::CAIXA_GESTAO_DEMANDAS_DO_NOC;
        $idGrupo = 121;
        $title = "CAIXA DE ENTRADA DA GESTÃO DE DEMANDAS DO NOC E ESCRITÓRIO DE PROJETOS";
        ...
        if (!is_null($data_pesq)) {
            ...
            $consulta_caixa = $caixas->getCaixaSemNivelPesq($idCaixa, array(), $order);
