...
class Sosti_GestaodemandasinfraestruturaController extends Zend_Controller_Action {
	/**
    ...
    public function indexAction() {
        ...
        $idCaixa = 20;
        $idGrupo = 119;
        $title = "CAIXA DE ENTRADA DE GESTÃO DE DEMANDAS DE INFRAESTRUTURA";
...
//                        $vinc[$sosti["SSOL_ID_DOCUMENTO"]][] = $caixas->getCaixaSemNivelPesq($idCaixa, $data_pesq, $order, $vincRow["VIDC_ID_DOC_VINCULADO"])->getData();
    ...
    public function encaminharAction() {
        ...
        foreach ($arr_sgrs_id_grupo as $value) {
            ...
            if (in_array($value_option["SGRS_ID_GRUPO"], array(2,  121))) {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($data['acao'] && isset($data['acao']) && $data['acao'] == 'Encaminhar') {
                ...
                if ($form->isValid($data)) {
                    ...
                    $this->view->title = "GESTÃO DE INFRAESTRUTURA - ENCAMINHAR SOLICITAÇÃO(ES)";
