<?php
class Application_Model_DbTable_SosTbSspaSolicPrazoAtend extends Zend_Db_Table_Abstract
{
    protected $_schema = 'SOS';
    protected $_name = 'SOS_TB_SSPA_SOLIC_PRAZO_ATEND';
    ...
    public function prazoSolicitacao($idDocumento, array $dataMofaMoviFase, array $dataSspaSolicPrazoAtend)
    {
        ...
        try {
            ...
            $rowUltima_fase = $tabelaSadTbDocmDocumento->find($idDocumento)->current();;
