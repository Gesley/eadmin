<?php
class Services_Red_Cancelar extends Services_Red_Abstract implements Services_Red_Interface
{
	public $parametros;
	...
	public function cancelar (Services_Red_Parametros_Interface $parametros)
	{
