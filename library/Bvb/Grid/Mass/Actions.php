...
class Bvb_Grid_Mass_Actions {
    ...
    public function setMassAction($url, $caption, $confirm='', $imagem='')
    {
        /* ASmR - Tradução ou alteração para compatibilização */
    	$options = array('url' => $url, 'caption' => $caption, 'confirm' => $confirm, 'imagem' => $imagem);
     ...
     */
    /* ASmR - Tradução ou alteração para compatibilização */
    public function addMassAction($url, $caption, $confirm='', $imagem='')
    {
        $options = array();
        /* ASmR - Tradução ou alteração para compatibilização */
        $options[] = array('url' => $url, 'caption' => $caption, 'confirm' => $confirm, 'imagem' => $imagem);
