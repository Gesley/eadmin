...
/**
 * @category	TRF1
 * @package		Trf1_Orcamento_Negocio_Demandante
 ...
 * 
 * TRF1, Classe negocial sobre Orçamento - Demandantes
 * 
 * ====================================================================================================
 * LICENSA
 * ====================================================================================================
 ...
 * 
 */
class Trf1_Orcamento_Negocio_Demandante {
	/**
	 * Model do Demandante da Despesa
	 */
	...
	public function __construct() {
		$this->_dados = new Application_Model_DbTable_Orcamento_CeoTbDemnDemandante ();
	}
	...
	public function retornaCombo() {
		...
		$cacheId = $cache->retornaID_Combo ( 'demandante' );
...
SELECT
	...
	DEMN_DS_DEMANDANTE
FROM
	CEO_TB_DEMN_DEMANDANTE_VALOR
WHERE
	DEMN_DH_EXCLUSAO_LOGICA IS NULL
ORDER BY
	DEMN_CD_DEMANDANTE
					";
	...
	public function retornaListagem() {
		// Verifica existência dos dados em cache
		$cache = new Trf1_Orcamento_Cache ();
		$cacheId = $cache->gerarID_Listagem ( 'demandante' );
		$dados = $cache->lerCache ( $cacheId );
...
WHERE
	 ...
	 *
	 * @param	int		$demandante				Chave primária para busca do registro
	 * @return	array
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistro($demandante) {
		$sql = "
SELECT
	DEMN_CD_DEMANDANTE,
	DEMN_DS_DEMANDANTE
FROM
	CEO_TB_DEMN_DEMANDANTE_VALOR 
WHERE
	DEMN_CD_DEMANDANTE					= $demandante	AND
	DEMN_DH_EXCLUSAO_LOGICA				IS NULL
				";
	 ...
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistroNomeAmigavel($demandante) {
		$sql = "
SELECT
	DEMN_CD_DEMANDANTE					AS \"Demandante\",
	DEMN_DS_DEMANDANTE					AS \"Descrição\"
FROM
	CEO_TB_DEMN_DEMANDANTE_VALOR 
WHERE
	DEMN_CD_DEMANDANTE					= $demandante	AND
...
FROM
	CEO_TB_DEMN_DEMANDANTE_VALOR 
WHERE
	DEMN_CD_DEMANDANTE					IN ($demandantes)	AND
	DEMN_DH_EXCLUSAO_LOGICA				IS NULL
				";
...
UPDATE
	CEO_TB_DEMN_DEMANDANTE_VALOR
SET
	DEMN_CD_MATRICULA_EXCLUSAO			= '$sessao->matricula',
	DEMN_DH_EXCLUSAO_LOGICA				= SYSDATE
WHERE
	DEMN_CD_DEMANDANTE					IN ($demandantes)	AND
	DEMN_DH_EXCLUSAO_LOGICA				IS NULL
				";
