...
/**
 * @category	TRF1
 * @package		Trf1_Orcamento_Negocio_Tiponc
 ...
 * 
 * TRF1, Classe negocial sobre Orçamento - Tipos das notas de crédito
 * 
 * ====================================================================================================
 * LICENSA
 * ====================================================================================================
 ...
 * 
 */
class Trf1_Orcamento_Negocio_Tiponc {
	/**
	 * Model dos Tipos das Notas de Crédito
	 */
	...
	public function __construct() {
		$this->_dados = new Application_Model_DbTable_Orcamento_CeoTbTpncTipoNC ();
	}
	...
	public function retornaCombo() {
		...
		$cacheId = $cache->retornaID_Combo ( 'tiponc' );
...
SELECT
	...
	TPNC_DS_TIPO_NC
FROM
	CEO_TB_TPNC_TIPO_NOTA_CREDITO
WHERE
	TPNC_DH_EXCLUSAO_LOGICA IS NULL
ORDER BY
	TPNC_CD_TIPO_NC
					";
	...
	public function retornaListagem() {
		// Verifica existência dos dados em cache
		$cache = new Trf1_Orcamento_Cache ();
		$cacheId = $cache->gerarID_Listagem ( 'tiponc' );
		$dados = $cache->lerCache ( $cacheId );
...
WHERE
	 ...
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistro($tipoNc) {
		$sql = "
SELECT
	TPNC_CD_TIPO_NC,
	TPNC_DS_TIPO_NC
...
WHERE
	 ...
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistroNomeAmigavel($tipoNc) {
		$sql = "
SELECT
	TPNC_CD_TIPO_NC							AS \"Tipo de nota de crédito\",
	TPNC_DS_TIPO_NC							AS \"Descrição\"
FROM
	CEO_TB_TPNC_TIPO_NOTA_CREDITO
WHERE
	TPNC_CD_TIPO_NC							= '$tipoNc'	AND
...
UPDATE
	CEO_TB_TPNC_TIPO_NOTA_CREDITO
SET
	TPNC_CD_MATRICULA_EXCLUSAO				= '$sessao->matricula',
	TPNC_DH_EXCLUSAO_LOGICA					= SYSDATE
WHERE
	TPNC_CD_TIPO_NC							IN ($tipos)	AND
	TPNC_DH_EXCLUSAO_LOGICA					IS Null
				";
