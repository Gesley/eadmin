...
/**
 * @category	TRF1
 * @package		Trf1_Orcamento_Negocio_Categoria
 ...
 * 
 * TRF1, Classe negocial sobre Orçamento - Categorias
 * 
 * ====================================================================================================
 * LICENSA
 * ====================================================================================================
 ...
 * 
 */
class Trf1_Orcamento_Negocio_Categoria {
	/**
	 * Model da Categoria
	 */
	...
	public function __construct() {
		$this->_dados = new Application_Model_DbTable_Orcamento_CeoTbCateCategoria ();
	}
	...
	public function retornaCombo() {
		...
		$cacheId = $cache->retornaID_Combo ( 'categoria' );
...
SELECT
        CATE_CD_CATEGORIA,
	CATE_CD_CATEGORIA || ' - ' || CATE_DS_CATEGORIA AS CATE_DS_CATEGORIA
FROM
	CEO_TB_CATE_CATEGORIA
WHERE
	CATE_DH_EXCLUSAO_LOGICA IS NULL
ORDER BY
	CATE_CD_CATEGORIA
					";
	...
	public function retornaListagem() {
		// Verifica existência dos dados em cache
		$cache = new Trf1_Orcamento_Cache ();
		$cacheId = $cache->gerarID_Listagem ( 'categoria' );
		$dados = $cache->lerCache ( $cacheId );
...
ORDER BY
	 ...
	 *
	 * @param	int		$categoria				Chave primária para busca do registro
	 * @return	array
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistro($categoria) {
		$sql = "
SELECT
	CATE_CD_CATEGORIA,
	CATE_DS_CATEGORIA
FROM
	CEO_TB_CATE_CATEGORIA
WHERE
	CATE_CD_CATEGORIA							= '$categoria'	AND
	CATE_DH_EXCLUSAO_LOGICA						IS NULL
ORDER BY
	CATE_CD_CATEGORIA
				";
	 ...
	 *
	 * @param	int		$tipoNc					Chave primária para busca do registro
	 * @return	array
	 * @author	Anderson Sathler M. Ribeiro [asathler@gmail.com]
	 */
	public function retornaRegistroNomeAmigavel($categoria) {
		$sql = "
SELECT
	CATE_CD_CATEGORIA							AS \"Categoria de gasto\",
	CATE_DS_CATEGORIA							AS \"Descrição da categoria\"
FROM
	CEO_TB_CATE_CATEGORIA
WHERE
	CATE_CD_CATEGORIA							= '$categoria'	AND
...
FROM
	CEO_TB_CATE_CATEGORIA
WHERE
	CATE_CD_CATEGORIA							IN ($categorias)	AND
	CATE_DH_EXCLUSAO_LOGICA						IS NULL
ORDER BY
	CATE_CD_CATEGORIA
				";
...
UPDATE
	CEO_TB_CATE_CATEGORIA
SET
	CATE_CD_MATRICULA_EXCLUSAO					= '$sessao->matricula',
	CATE_DH_EXCLUSAO_LOGICA						= SYSDATE
WHERE
	CATE_CD_CATEGORIA							IN ($categorias)	AND
	CATE_DH_EXCLUSAO_LOGICA						IS Null
				";
