    ...
    $('input[name=acao]').click(
        function(){
            ...
            if(acao == 'Encaminhar'){
                ...
                formhelpdesk.attr('action',base_url + '/sosti/solicitacao/baixarcaixa');
            }else if(acao == 'Espera'){
                ...
                formhelpdesk.attr('action',base_url + '/sosti/solicitacao/vincular');
            }else if(acao == 'Desvincular'){
                formhelpdesk.attr('action',base_url + '/sosti/solicitacao/desvincular');
            }else if(acao == 'Parecer'){
                formhelpdesk.attr('action',base_url + '/sosti/solicitacao/parecer');
            }else if(acao == 'Categorias'){
                formhelpdesk.attr('action',base_url + '/sosti/categorias/categorizar');
            }else if(acao == 'Excel'){
                ...
                formhelpdesk.attr('action',base_url + '/sosti/solicitacao/cancelar');
            }else if (acao == 'Extensão de Prazo') {
                formhelpdesk.attr('action', base_url + '/sosti/solicitacao/extenderprazo');
            }else if (acao == 'Associar Sostis') {
                formhelpdesk.attr('action', base_url + '/sosti/pesquisarsolicitacoes/associarpesquisar');
            }
        }
        );
