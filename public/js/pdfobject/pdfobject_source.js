...
var PDFObject = function(obj) {
    ...
    var embed = function(targetID) {
        ...
        mensagemErro = '<div class="error"><strong>Erro:</strong> Não foi possível localizar o pdf do documento.</div>';
        targetNode.innerHTML = '<object	data="' + url + '" type="application/pdf" width="' + width + '" height="' + height + '">' + mensagemErro + '</object>';
